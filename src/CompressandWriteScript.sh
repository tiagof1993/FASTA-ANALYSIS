...
rm ordered_shuffled_size.fasta
rm ordered_shuffled_AT.fasta
rm ordered_shuffled_CG.fasta
rm ordered_shuffled_size.naf
rm ordered_shuffled_AT.naf
rm ordered_shuffled_CG.naf
rm ordered_shuffled_size.fasta.mfc
rm ordered_shuffled_AT.fasta.mfc
rm ordered_shuffled_CG.fasta.mfc
rm ordered_shuffled_size.fasta.gz
rm ordered_shuffled_AT.fasta.gz
rm ordered_shuffled_CG.fasta.gz
rm ordered_shuffled_size.fasta.lzma
rm ordered_shuffled_AT.fasta.lzma
rm ordered_shuffled_CG.fasta.lzma
rm ordered_shuffled_size.fasta.bz2
rm ordered_shuffled_AT.fasta.bz2
rm ordered_shuffled_CG.fasta.bz2
rm ordered_shuffled_size_naf.fasta
rm ordered_shuffled_AT_naf.fasta
rm ordered_shuffled_CG_naf.fasta
rm ordered_shuffled_size.fasta.mfc.d
rm ordered_shuffled_AT.fasta.mfc.d
rm ordered_shuffled_CG.fasta.mfc.d
rm ordered_shuffled_size_gz.fasta
rm ordered_shuffled_AT_gz.fasta
rm ordered_shuffled_CG_gz.fasta
...
rm ordered_CVDB_size.fasta
rm ordered_CVDB_AT.fasta
rm ordered_CVDB_CG.fasta
rm ordered_CVDB_size.naf
rm ordered_CVDB_AT.naf
rm ordered_CVDB_CG.naf
rm ordered_CVDB_size.fasta.mfc
rm ordered_CVDB_AT.fasta.mfc
rm ordered_CVDB_CG.fasta.mfc
rm ordered_CVDB_size.fasta.gz
rm ordered_CVDB_AT.fasta.gz
rm ordered_CVDB_CG.fasta.gz
rm ordered_CVDB_size.fasta.lzma
rm ordered_CVDB_AT.fasta.lzma
rm ordered_CVDB_CG.fasta.lzma
rm ordered_CVDB_size.fasta.bz2
rm ordered_CVDB_AT.fasta.bz2
rm ordered_CVDB_CG.fasta.bz2
rm ordered_CVDB_size_naf.fasta
rm ordered_CVDB_AT_naf.fasta
rm ordered_CVDB_CG_naf.fasta
rm ordered_CVDB_size.fasta.mfc.d
rm ordered_CVDB_AT.fasta.mfc.d
rm ordered_CVDB_CG.fasta.mfc.d
rm ordered_CVDB_size_gz.fasta
rm ordered_CVDB_AT_gz.fasta
rm ordered_CVDB_CG_gz.fasta
...
rm shuffled.fasta.mfc
rm shuffled.fasta.gz
rm shuffled.fasta.lzma
rm shuffled.fasta.bz2
rm shuffled_naf.fasta
rm shuffled.fasta.mfc.d
rm shuffled_gz.fasta
