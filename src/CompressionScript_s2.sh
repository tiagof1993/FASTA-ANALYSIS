...
{ /bin/time -f "TIME\t%e\tMEM\t%M" ./MFCompressC -v -3 -p 64 -t 8 shuffled.fasta ; } 2>>mf_compresstimes_s2.txt
...
{ /bin/time -f "TIME\t%e\tMEM\t%M" ./MFCompressD -v -3 -p 64 -t 8 shuffled.fasta.mfc ; } 2>>mf_decompresstimes_s2.txt
