...
# gnome-terminal -- bash -c " ./compression_lzma.sh ${sorting_types[0]} ${INPUT_FILE[0]} $test 0 ; ./compression_lzma.sh ${sorting_types[0]} ${INPUT_FILE[1]} $test 0  ; ./compression_lzma.sh ${sorting_types[0]} ${INPUT_FILE[0]} $test $sorted ; ./compression_lzma.sh ${sorting_types[0]} ${INPUT_FILE[1]} $test 1  ; ./csv_builder_lzma.sh ${sorting_types[0]} ${INPUT_FILE[0]} $test ; ./csv_builder_lzma.sh ${sorting_types[0]} ${INPUT_FILE[1]} $test ; ./plot_lzma.sh ${INPUT_FILE[0]} ${INPUT_FILE[1]} ${sorting_types[0]} ; \
